...
// ... your existing utils.js code above ...

// ======== ADD THESE NEW FUNCTIONS HERE ========

/**
 * Make Graph API request with proper headers and error handling
 */
async function graphApiRequest(url, data, headers, method = 'POST') {
...
// ======== YOUR EXISTING EXPORTS SECTION BELOW ========
...
module.exports = {
    ...
    getFroms,
    // Add these new functions for Graph API support
    graphApiRequest: graphApiRequest,
